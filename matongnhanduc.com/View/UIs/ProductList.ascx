<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProductList.ascx.cs" Inherits="matongnhanduc.UIs.ProductList" %>
        ...
        <ItemTemplate>
            <article class="mediaPro">
                ...
                <div class="text-media">
                    ...
                    <div class="linkview">Giá: <span>200.000 <u>đ</u></span></div>
                </div>
            </article>                 
        </ItemTemplate>
    </asp:Repeater>        
