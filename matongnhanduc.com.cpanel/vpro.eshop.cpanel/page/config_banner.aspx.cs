...
namespace matongnhanduc.com.page
{
    public partial class config_banner : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ucHeader.HeaderLevel1 = "Cấu hình chung";
                ucHeader.HeaderLevel1_Url = "../page/config_meta.aspx";
                ucHeader.HeaderLevel2 = "Cấu hình Banner";
                ucHeader.HeaderLevel2_Url = "../page/config_banner.aspx";
        ...
        protected void GridItemList_SortCommand(object source, DataGridSortCommandEventArgs e)
        {
            ...
            DataTable dataTable = Session["BannerList"] as DataTable;
        ...
        protected void GridItemList_PageIndexChanged(object source, DataGridPageChangedEventArgs e)
        {
            ...
            GridItemList.DataSource = Session["BannerList"] as DataTable;
            GridItemList.DataBind();
        }
