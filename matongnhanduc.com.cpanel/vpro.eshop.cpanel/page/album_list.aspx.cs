...
namespace matongnhanduc.com.page
{
    ...
    public partial class album_list : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ucHeader.HeaderLevel1 = "Album quảng cáo";
                ucHeader.HeaderLevel1_Url = "../page/album_list.aspx";
                ucHeader.HeaderLevel2 = "Danh sách album";
                ucHeader.HeaderLevel2_Url = "../page/album_list.aspx";
        ...
        {
            return "album.aspx?album_id=" + Utils.CStrDef(obj_id);
        }
        ...
        private void EventDelete(DataGridCommandEventArgs e)
        {
            try
            {
                ...
                var g_delete = DB.GetTable<ESHOP_ALBUM>().Where(g => g.ALBUM_ID == CustomerId);

                DB.ESHOP_ALBUMs.DeleteAllOnSubmit(g_delete);
                DB.SubmitChanges();
            ...
            {
                Response.Redirect("album_list.aspx");
            }
        }
        ...
        protected void lbtDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //delete 
                var g_delete = DB.GetTable<ESHOP_ALBUM>().Where(g => items.Contains(g.ALBUM_ID));
        ...
        protected void lbtSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                foreach (DataGridItem item in GridItemList.Items)
                {
                    ...
                    if (check.Checked)
                    {
                        strLink = "album.aspx?album_id=" + Utils.CStrDef(GridItemList.DataKeys[i]);
                        break;
                    }
                    i++;
                }
        ...
        protected void GridItemList_SortCommand(object source, DataGridSortCommandEventArgs e)
        {
            ...
            DataTable dataTable = Session["AlbumList"] as DataTable;
        ...
        protected void GridItemList_PageIndexChanged(object source, DataGridPageChangedEventArgs e)
        {
            ...
            GridItemList.DataSource = Session["AlbumList"] as DataTable;
            GridItemList.DataBind();
        }
