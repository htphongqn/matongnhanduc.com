    ...
    public partial class point_list : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ucHeader.HeaderLevel2 = "Tích lũy điểm";
                ucHeader.HeaderLevel2_Url = "../page/point_list.aspx";
        ...
        {
            return "point.aspx?point_id=" + Utils.CStrDef(obj_id);
        }
        ...
        private void EventDelete(DataGridCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("point_list.aspx");
            }
        }
        ...
        protected void lbtSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                foreach (DataGridItem item in GridItemList.Items)
                {
                    ...
                    if (check.Checked)
                    {
                        strLink = "point.aspx?point_id=" + Utils.CStrDef(GridItemList.DataKeys[i]);
                        break;
                    }
                    i++;
                }
