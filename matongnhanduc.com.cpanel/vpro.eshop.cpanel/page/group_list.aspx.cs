    ...
    public partial class group_list : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ucHeader.HeaderLevel2_Url = "../page/group_list.aspx";
        ...
        protected void lbtSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                foreach (DataGridItem item in GridItemList.Items)
                {
                    ...
                    if (check.Checked)
                    {
                        strLink = "groups.aspx?group_id=" + Utils.CStrDef(GridItemList.DataKeys[i]);
                        break;
                    }
                    i++;
                }
        ...
        protected void GridItemList_SortCommand(object source, DataGridSortCommandEventArgs e)
        {
            ...
            DataTable dataTable = Session["GroupList"] as DataTable;
        ...
        protected void GridItemList_PageIndexChanged(object source, DataGridPageChangedEventArgs e)
        {
            ...
            GridItemList.DataSource = Session["GroupList"] as DataTable;
            GridItemList.DataBind();
        }
