    ...
    public partial class websitelink_list : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ucHeader.HeaderLevel2_Url = "../page/websitelink_list.aspx";
        ...
        protected void lbtSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                foreach (DataGridItem item in GridItemList.Items)
                {
                    ...
                    if (check.Checked)
                    {
                        strLink = "websitelink.aspx?website_id=" + Utils.CStrDef(GridItemList.DataKeys[i]);
                        break;
                    }
                    i++;
                }
        ...
        protected void GridItemList_SortCommand(object source, DataGridSortCommandEventArgs e)
        {
            ...
            DataTable dataTable = Session["WebsiteList"] as DataTable;
        ...
        protected void GridItemList_PageIndexChanged(object source, DataGridPageChangedEventArgs e)
        {
            ...
            GridItemList.DataSource = Session["WebsiteList"] as DataTable;
            GridItemList.DataBind();
        }
